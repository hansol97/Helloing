	...
	<br><br><br><br>
		...
		<div class="main-img" align="center">
			...
			<form>
				...
				<input type="checkbox" name="chk">개인정보 수집 및 이용(필수)<button type='button' id="modal_btn1">개인정보 수집 및 이용약관 보기</button>
				<div class="black_bg1"></div>
				<br><br>
				
				<input type="checkbox" name="chk">위치기반서비스(필수)<button type='button' id="modal_btn2">위치기반서비스 이용약관 보기</button>	
